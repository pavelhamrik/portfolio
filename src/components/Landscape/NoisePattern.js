        ...
        return (
            <React.Fragment>
                <filter id='displacementFilter'>
                    ...
                    <feDisplacementMap in2='turbulence' in='SourceGraphic' scale='100' stitchTiles='stitch'
                                       xChannelSelector='R' yChannelSelector='G'/>
                </filter>
                <pattern id={id} x='0' y='0' width='100' height='100' patternUnits='userSpaceOnUse'>
                    <circle cx='70' cy='70' r='50' fill='none' stroke={color} strokeWidth='5' strokeOpacity={opacity}
                            style={displacementFilter} transform={transform} />
                </pattern>
            </React.Fragment>
        );
    }
